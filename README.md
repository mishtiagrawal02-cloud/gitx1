...
<video src="assets/demo-video.mp4" width="100%" controls autoplay loop muted playsinline></video>

*(If the video player doesn't render, [click here to view the raw mp4 file](assets/demo-video.mp4).)*
