 ...
 * @returns {string}
 */
export function analyze_diff(diff_text) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(diff_text, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.analyze_diff(retptr, ptr0, len0);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gitx1_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
